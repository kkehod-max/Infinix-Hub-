...
-- ============================================
-- MAGNET PICKUP SYSTEM (แทน ItemESP บนพื้น)
-- ============================================
local MagnetPickupEnabled = false
local MAGNET_RADIUS = 2000
...
ESPTab:Divider()
ESPTab:Section({Title = "ดูดไอเทมอัตโนมัติ (แม็กเน็ต)"})
ESPTab:Toggle({Title = "เปิดใช้งานดูดไอเทม", Desc = "ไอเทมจะลอยมาเข้าตัวอัตโนมัติในรัศมีที่ตั้งค่า", Default = false, Callback = function(v) 
...
ESPTab:Slider({Title = "รัศมีการดูด", Step = 100, Value = {Min = 500, Max = 5000, Default = 2000}, Callback = function(v) 
    MAGNET_RADIUS = v
end})
ESPTab:Slider({Title = "ความเร็วในการดูด", Step = 0.1, Value = {Min = 0.3, Max = 2, Default = 0.8}, Callback = function(v) 
    MAGNET_SPEED = v
end})
...
GunModTab:Slider({Title = "ความทนทาน", Step = 1000, Value = {Min = 1000, Max = 999999, Default = 999999}, Callback = function(v) getgenv().DurabilityValue = v end})
