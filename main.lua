...
local RainbowSpeed = 0.4 -- รอบต่อวินาที (ปรับได้)
...
local RunService=b(game:GetService"RunService")
...
-- อัพเดท Primary ใน theme ปัจจุบัน
if p.Theme then
p.Theme.Primary=rainbowColor
end

-- อัพเดท objects ที่ใช้ Primary
for _,v in pairs(p.Objects)do
for prop,themeKey in pairs(v.Properties or{})do
if themeKey=="Primary"then
local ok=pcall(function()
v.Object[prop]=rainbowColor
end)
end
end
end
...
-- Rainbow control functions (เรียกใช้ได้จากภายนอก)
function p.SetRainbowSpeed(r)
RainbowSpeed=math.clamp(r,0.01,10)
end

function p.SetRainbowEnabled(r)
RainbowEnabled=r
end
